...
public class Mail {
    private final String EmailEnvio = "10lifegoals@gmail.com";
    private final String SenhaEnvio = "bbfe1234";

    private String emailDestinario;
    private String assunto;
    private String msg;

    public Mail(String emailDestinario, String assunto, String msg) {
...
//
//        _from = _user = "10lifegoals@gmail.com"; // usuário e email do remetente
//        _pass = "bbfe1234"; // senha
//        _subject = ""; // assunto
//        _body = ""; // mensagem html
//
//        _debuggable = false;
